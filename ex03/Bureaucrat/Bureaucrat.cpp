...
void Bureaucrat::executeForm(const AForm &form) {
	try {
		std::cout << ColorFormat::formatString(getName(), "blue", "italic") << " tries to execute the following form:\n" << form << std::endl;
		form.execute(*this);
		std::cout << ColorFormat::formatString(getName(), "blue", "italic") <<
					 ColorFormat::formatString(" successfully", "green") << " executed " <<
					 ColorFormat::formatString(form.getName(), "magenta", "italic") << std::endl;
	} catch (const std::exception &e) {
		std::cout << ColorFormat::formatString(getName(), "blue", "italic") << " was "
				  << ColorFormat::formatString("unable", "red") << " to execute "
				  << ColorFormat::formatString(form.getName(), "magenta", "italic") << ": "
				  << ColorFormat::formatString(e.what(), "red") << std::endl;
	}
}